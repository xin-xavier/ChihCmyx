...
public class JvpMultipleStatusView  extends RelativeLayout {
    private static final String TAG = "JvpMultipleStatusView";
    ...
    private JvpMultipleStatusView.OnViewStatusChangeListener mViewStatusListener;

    private final ArrayList<Integer> mOtherIds = new ArrayList<>();

    public JvpMultipleStatusView(Context context) {
        this(context, null);
    }

    public JvpMultipleStatusView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JvpMultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setOnViewStatusChangeListener(JvpMultipleStatusView.OnViewStatusChangeListener onViewStatusChangeListener) {
    ...
    public static JvpMultipleStatusView attach(Fragment fragment, int rootAnchor) {
    ...
    public static JvpMultipleStatusView attach(Activity activity, int rootAnchor) {
        if (-1 != rootAnchor) {
    ...
    public static JvpMultipleStatusView attach(ViewGroup rootAnchor) {
        if (null == rootAnchor) {
        ...
        if (-1 != anchorIndex) {
            ...
            JvpMultipleStatusView statusView = new JvpMultipleStatusView(rootAnchor.getContext());
