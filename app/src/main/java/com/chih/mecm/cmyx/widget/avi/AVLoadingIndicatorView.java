package com.chih.mecm.cmyx.widget.avi;
...
import com.chih.mecm.cmyx.widget.avi.indicators.BallPulseIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, ColorUtils.getColor(R.color.main_orange));
    ...
    public void setIndicator(String indicatorName){
        ...
        if (!indicatorName.contains(".")){
            String defaultPackageName= Objects.requireNonNull(getClass().getPackage()).getName();
